...
#ifndef ZeroZumoReflectanceSensorArray_h
#define ZeroZumoReflectanceSensorArray_h

#include <ZeroQTRSensors.h>
#include <Arduino.h>
...
//    unsigned char sensorPins[] = { 4, A3, 11, A0, A2, 5 };
    unsigned char sensorPins[] = { 4, A3, 11, A2, 5 }; // for our zumo shields
